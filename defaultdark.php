 ...
 */
class XoopsGuiDefaultdark extends XoopsSystemGui
{
    /**
     *
     */
    ...
    public function header()
    {
        ...
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/defaultdark/js/styleswitch.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/defaultdark/js/formenu.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/defaultdark/js/menu.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/defaultdark/js/tooltip.js');
//        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/defaultdark/js/tabs.jquery.tools.min.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/defaultdark/js/tabs.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/defaultdark/js/tabs.slideshow.js');

        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/defaultdark/css/style.css');
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/defaultdark/css/dark.css', array('title' => 'dark', 'media' => 'screen'));
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/defaultdark/css/silver.css', array('title' => 'silver', 'media' => 'screen'));
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/defaultdark/css/orange.css', array('title' => 'orange', 'media' => 'screen'));
...
//        $tpl->assign('allow_call_time_pass_reference', ini_get('allow_call_time_pass_reference') ? 'On' : 'Off');
        ...
        $menu[1]['absolute'] = 1;
        $menu[1]['icon']     = XOOPS_ADMINTHEME_URL . '/defaultdark/images/xoops.png';
        $menu[2]['link']     = XOOPS_URL . '/user.php?op=logout';
        $menu[2]['title']    = _LOGOUT;
        $menu[2]['absolute'] = 1;
        $menu[2]['icon']     = XOOPS_ADMINTHEME_URL . '/defaultdark/images/logout.png';
        ...
        if (empty($xoopsModule) || 'system' === $xoopsModule->getVar('dirname', 'n')) {
            ...
            foreach (array_keys($mod_options) as $item) {
                ...
                $mod_options[$item]['icon'] = empty($mod_options[$item]['icon']) ? '' : XOOPS_ADMINTHEME_URL . '/defaultdark/' . $mod_options[$item]['icon'];
        ...
        $OPT[] = array(
            ...
            'absolute' => 1,
            'icon'     => XOOPS_ADMINTHEME_URL . '/defaultdark/icons/prefs_small.png');
        $OPT[] = array(
        ...
        $menu[] = array(
            ...
            'absolute' => 1,
            'icon'     => XOOPS_ADMINTHEME_URL . '/defaultdark/images/xoops.png');
        $menu[] = array(
        ...
        $menu[] = array(
            ...
            'absolute' => 1,
            'icon'     => XOOPS_ADMINTHEME_URL . '/defaultdark/images/tweb.png');
        ...
        if (file_exists($file = XOOPS_ADMINTHEME_PATH . '/defaultdark/language/' . $xoopsConfig['language'] . '/localsupport.php')) {
            $links = include XOOPS_ADMINTHEME_PATH . '/defaultdark/language/' . $xoopsConfig['language'] . '/localsupport.php';
            if (count($links) > 0) {
